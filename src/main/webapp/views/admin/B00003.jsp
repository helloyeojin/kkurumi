...
<style>
    ...
    .phone-box {
        width: 300px;
        height: 500px;
        background-image: url('img/real-estate/iphone.png');
                ...
                <div class="offcanvas-header d-block border-bottom pt-0 pt-lg-4 px-lg-0">
                    <form class="form-group mb-lg-2 rounded-pill">
                        <div class="input-group">
                            ...
                            <input class="form-control" type="text" placeholder="KB PIN 입력" id="customerPin">
                        </div>
                        <button class="btn btn-primary rounded-pill d-lg-inline-block d-none" type="button"
                                onclick="searchAndDisplay()">검색
                        </button>
                        <button class="btn btn-icon btn-primary rounded-circle flex-shrink-0 d-lg-none d-inline-flex"
                                type="button" onclick="searchAndDisplay()"><i class="fi-search mt-n2"></i></button>
                    </form>
                </div>

                <div class="box-media bg-faded-warning text-warning mb-3 mx-auto"
                     style="width: 13em; height: 13em; border-radius: 0.5rem; display: none;" id="customerProfile">
                    ...
                    <div class="collapse d-md-block" id="account-nav1">
                        <ul class="nav nav-pills flex-column flex-md-row pt-3 pt-md-0 pb-md-4 border-bottom-md">
                            ...
                            <li class="nav-item mb-md-0 me-md-2 pe-md-1"><a class="nav-link">#증권사 근무</a></li>
                            <li class="nav-item mb-md-0 me-md-2 pe-md-1"><a class="nav-link">#100백만 초과</a></li>
                        </ul>
                    ...
                    <div class="offcanvas-header d-block border-bottom py-lg-4 py-3 px-lg-0" style="margin-top:30px; ">
                        <ul class="nav nav-pills" role="tablist">
                            <li class="nav-item"><a class="nav-link d-flex align-items-center active" href="#categories"
                                    ...
                                    class="fi-list me-2"></i>상품카테고리</a></li>
                                    ...
                                    <div class="col">
                                        <div class="dropdown h-100"><a
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end my-1"><a
                                                    ...
                                                    href="real-estate-catalog-rent.html"><i
                                                    class="fi-computer fs-base opacity-60 me-2"></i>Office</a><a
                                                    class="dropdown-item fw-bold"
                                                    href="real-estate-catalog-sale.html"><i
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-4">
                            <div class="custom-box"><h4>실시간 많이 본 상품</h4>
                                ...
                                <ul id="searchRanking" class="search-ranking"
                                    style="list-style: none; padding-left: 0em; "></ul>
                        ...
                        <div class="col-md-4">
                            <div class="custom-box"><h4>재 가입이 높은 상품</h4>
                                ...
                                <ul id="searchRanking2" class="search-ranking2"
                                    style="list-style: none; padding-left: 0em"></ul>
                        ...
                        <div class="col-md-4">
                            <div class="custom-box"><h4>실시간 판매량 순위</h4>
                                <ul id="searchRanking3" class="search-ranking"
                                    style="list-style: none; padding-left: 0em"></ul>
                            </div>
                        </div>
            ...
            <div class="수치" id="customerProfile2" style="background-color: #f9f9f9; margin-top: 50px;">
                ...
                <div class="container">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-4">
                            <div class="custom-box"><h4>가입 확률이 높아요</h4>
                                <table class="table table-striped">
                                    <thead>
                                    <tr>
                                        <th>순위</th>
                                    ...
                                    <tr class="table-active">
                                        <th scope="row">1</th>
                                        <td>노리체크카드<i class="fi-arrow-up red-arrow" style="margin-left: 1em"></i></td>
                                    </tr>
                                    <tr class="table">
                                        <th scope="row">2</th>
                                        <td>스카이마일리지카드<i class="fi-arrow-down blue-arrow" style="margin-left: 1em"></i>
                                        </td>
                                    </tr>
                                    <tr class="table">
                                        <th scope="row">3</th>
                                        <td>베브3카드<i class="fi-arrow-up red-arrow" style="margin-left: 1em"></i></td>
                                    </tr>
                                    <tr class="table">
                                        <th scope="row">4</th>
                                        <td>이지올카드</td>
            ...
            <div class="수치" id="customerProfile4" style="background-color: #f9f9f9; margin-top: 50px;">
                <div class="container row justify-content-center mb-4">
                    <div class="text-center mt-4">
                        <p style="font-weight: bold; font-size: large">AI 마케팅 문자</p>
                    </div>
