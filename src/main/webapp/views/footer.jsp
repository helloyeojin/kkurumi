...
<footer class="footer bg-secondary pt-5">
      ...
      <div class="col-lg-6 mb-lg-0 mb-4">
        <div class="d-flex flex-sm-row flex-column justify-content-between mx-n2">
          <div class="mb-sm-0 mb-4 px-2"><a class="d-inline-block mb-4" href="real-estate-home-v1.html"><img src="/img/logo/logo_bank_long.png" width="116" alt="logo"></a>
            ...
            <div class="pt-2">
              <a class="btn btn-icon btn-light-primary btn-xs shadow-sm rounded-circle me-2 mb-2" href="https://www.facebook.com/kbkookminbank"><i class="fi-facebook"></i></a>
              <a class="btn btn-icon btn-light-primary btn-xs shadow-sm rounded-circle me-2 mb-2" href="https://www.instagram.com/kbkookminbank"><i class="fi-instagram"></i></a>
              <a class="btn btn-icon btn-light-primary btn-xs shadow-sm rounded-circle me-2 mb-2" href="https://www.youtube.com/user/openkbstar"><i class="fi-youtube"></i></a>
              <a class="btn btn-icon btn-light-primary btn-xs shadow-sm rounded-circle me-2 mb-2" href="https://blog.naver.com/youngkbblog"><i class="fi-chat-left"></i></a>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="text-center fs-sm pb-4">&copy; Copyright KB Kookmin Bank. All rights reserved.</div>
  </div>
</footer>
<!-- Back to top button-->
