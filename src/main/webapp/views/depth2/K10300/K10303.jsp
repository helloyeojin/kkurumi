...
<section class="container mt-5 mb-lg-5 mb-4 pt-5 pb-lg-5">
    ...
    <nav class="mb-3 pt-md-3" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="/K10300">적금</a></li>
            <li class="breadcrumb-item active" aria-current="page">KB장병내일준비적금</li>
        </ol>
    </nav>
        ...
        <div class="col-lg-7">
            <div class="d-flex flex-column">
                ...
                <div class="order-lg-2 order-1">
                    <h1 class="h2 mb-2">KB장병내일준비적금</h1>
                    <p class="mb-4 pb-1 fs-lg">국군장병 미래준비 맞춤적금</p>
                    <ul class="d-flex pb-lg-2 list-unstyled" style="margin-bottom: 0">
                        <li class="me-3 pe-3 border-end"><b class="me-1">연 3.5% ~ 5.5%</b></li>
                        <li class="me-3 pe-3 border-end">※ 2023.11.11 기준, 세금공제전, 우대금리포함</li>
                    </ul>
                    <ul class="d-flex mb-4 pb-lg-2 list-unstyled">
                        <li class="me-3 pe-3 border-end"><b class="me-1">비과세종합저축으로만 가입 가능</b></li>
            ...
            <!-- Overview-->
            <h2 class="h5">상품특징</h2>
            <p class="mb-4 pb-2">병사봉급 한도 내에서 복무기간 동안 목돈마련을 원하는 병역 의무복무자 맞춤형 상품으로, 은행 거래실적에 따라 추가 우대이율 제공</p>
            <h2 class="h5">가입대상</h2>
            <p>가입시점에 아래 ①, ② 조건을 모두 충족하는 현역병, 상근예비역, 의무경찰, 해양의무경찰, 의무소방원, 대체복무요원, 사회복무요원(※ 1인 1계좌 제한)</p>
            <p>① 이 적금 신규일 기준으로 남은 의무복무기간이 6개월 이상</p>
            <p>② 가입대상임을 증빙하는 ‘장병내일준비적금 가입자격 확인서주)’원본 제출</p>
            <p class="mb-4">※ 확인서를 제출하지 않은 경우 상품가입 불가</p>
            <p class="mb-4 pb-2">※ 기존 가입대상 증빙서류인 '장병내일준비적금 가입·재정지원 자격 확인서' 의 경우, 2019.3.31 이전 발급분에 한하여 발급일로부터 3개월까지 사용 가능. 단, 조세특례제산법의 제129조2에 따른 금융소득종합과세 대상자는 모든 조건 충족하여도 가입 불가.</p>
            <h2 class="h5">상품유형</h2>
            <p>자유적립식 예금</p>
            <p class="mb-4 pb-2">※ 매월(1일~말일) 자유롭게 저축(만기일 전일까지 저축 가능)</p>
            <h2 class="h5">저축금액</h2>
            <p>월 1천원 ~ 20만원(단, 신규금액만 영업점 신규 0원이상, 비대면 신규 10원 이상)</p>
            <p>※ 단, ‘장병내일준비적금’ 상품을 판매하는 모든 은행을 합산하여 고객의 최대 저축한도는 월 40만원이며, 동 저축한도를 초과하지 않는 범위 내에서 은행 별 월 20만원까지 저축 가능</p>
            <h2 class="h5">계약기간</h2>
            <p>6개월 이상 24개월 이하(일 단위 만기일 지정)</p>
            <p>※ 만기일은 고객의 전역예정일(또는 소집해제예정일)이며, 단축·연장 할 수 없음</p>
            <h2 class="h5">이자지급시기</h2>
            <p>만기일시지급식</p>
            <!-- Rental agent-->
            <h2 class="h5">유의사항</h2>
                ...
                <blockquote class="blockquote card-body p-4">
                    <ul class="list-unstyled mt-n2 mb-0" style="font-size: 0.8rem">
                        <li>⊙ 이 금융상품을 가입하시기 전에 상품설명서 및 약관을 읽어보시기 바랍니다.</li>
                         <li>⊙ 이 적금은 공동명의로 가입할 수 없으며, 양도가 불가합니다.</li>
                        <li>⊙ 만기 전 해지할 경우 비과세 및 재정지원금 혜택을 받을 수 없습니다.</li>
                        <li>⊙ 이 적금을 예약신규로 신청하는 경우 예약신규일(실제 적금의 신규일) 기준으로 고객의 남은 의무복무기간이 6개월 미만이 되는 경우에는 예금신규가 불가합니다.</li>
                        <li>⊙ 이 적금은 ‘KB국민은행’과 ‘국방부(병무청)’간 업무협약에 의해 운영되는 상품으로, 향후 업무협약 및 관련 법 변경에 따라 상품내용이 변경될 수 있습니다.</li>
                        <li>⊙ 이 적금을 한번이라도 만기해지한 고객은 재 가입이 불가합니다.</li>
                        <li>⊙ 계좌에 압류, 가압류 등이 등록 될 경우 원금 및 이자지급이 제한 될 수 있습니다.</li>
                        <li>⊙ 만기 전 해지할 경우 계약에서 정한 이율보다 낮은 중도해지이율이 적용됩니다.</li>
        ...
        <aside class="col-lg-5">
            <div class="ps-lg-5">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <div><span class="badge bg-success me-2 mb-2">국군장병 추천</span></div>
                ...
                <h2 class="h3 mb-4 pb-2">3.5% ~ 5.5%<span class="d-inline-block ms-1 fs-base fw-normal text-body">/ 연</span></h2>
                <!-- Property details-->
                ...
                <div class="card border-0 bg-secondary mb-4">
                    <div class="card-body">
                        <h5 class="mb-0 pb-3"><i class="fi-star mt-n1 me-2 fs-lg align-middle"></i>급여이체로 우대이율 받고!</h5>
                        <ul class="list-unstyled mt-n2 mb-0">
                            <li class="mt-2 mb-0">급여이체 또는 주택청약종합저축 보유한 고객은</li>
                            <li class="mt-2 mb-0">최고 0.5%p의 우대이율을 받을 수 있어요.</li>
                        </ul>
                    </div>
                </div>
                <div class="card border-0 bg-secondary mb-4">
                    <div class="card-body">
                        <h5 class="mb-0 pb-3"><i class="fi-star mt-n1 me-2 fs-lg align-middle"></i>만기시 비과세와 정부지원금 혜택까지!</h5>
                        <ul class="list-unstyled mt-n2 mb-0">
                            <li class="mt-2 mb-0">상품 만기일까지 유지하면 비과세 혜택이 제공되며,</li>
                            <li class="mt-2 mb-0">'1% 이자지원금' 및 '매칭지원금' 혜택을 받을 수 있어요.</li>
                        </ul>
                    </div>
                </div>
