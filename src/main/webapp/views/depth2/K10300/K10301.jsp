...
<section class="container mt-5 mb-lg-5 mb-4 pt-5 pb-lg-5">
    ...
    <nav class="mb-3 pt-md-3" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">직장인우대적금</li>
        </ol>
    </nav>
    <div class="row gy-5 pt-lg-2">
        <div class="col-lg-7">
            <div class="d-flex flex-column">
                ...
                <div class="order-lg-2 order-1">
                    <h1 class="h2 mb-2">직장인우대적금</h1>
                    <p class="mb-4 pb-1 fs-lg">직장인의 알짜배기 재테크</p>
                    <ul class="d-flex pb-lg-2 list-unstyled" style="margin-bottom: 0">
                        <li class="me-3 pe-3 border-end"><b class="me-1">연 2.85% ~ 4.05%</b></li>
            ...
            <!-- Overview-->
            <h2 class="h5">상품특징</h2>
            <p class="mb-4 pb-2">직장인의 재테크 스타일을 반영하여 급여이체를 하거나 보너스 등의 부정기적인 자금을 추가로 적립하는 경우 우대이율로 목돈마련을 지원하고 결혼, 출산, 이사 등 이벤트를 위한 중도해지시 기본이율을 제공 하는 적립식 예금</p>
            <h2 class="h5">가입대상</h2>
            <p>실명의 개인(개인사업자 제외)</p>
            <h2 class="h5">상품유형</h2>
            <p>정액적립식 예금</p>
            <p class="mb-4">※ 신규 시 약정한 저축금액을 매월 약정한 날짜에 동일하게 저축</p>
            <p class="mb-4 pb-2">※ 분기별 1회에 한하여 추가적립(보너스저축) 가능</p>
            <h2 class="h5">저축금액</h2>
            <p>- 정액적립 : 월 1만원 ~ 3백만원 (원단위)</p>
            <p>- 추가적립 : 월 정액적립금액을 초과한 금액으로 최대 5백만원 이하 (원단위)</p>
            <h2 class="h5">계약기간</h2>
            <p>1년제, 2년제, 3년제</p>
        ...
        <aside class="col-lg-5">
            <div class="ps-lg-5">
                ...
                <h2 class="h3 mb-4 pb-2">2.85% ~ 4.05%<span class="d-inline-block ms-1 fs-base fw-normal text-body">/ 연</span></h2>
                <!-- Property details-->
                <a class="btn btn-lg btn-primary w-100 mb-3" href="https://obank.kbstar.com/quics?page=C016613&cc=b061496:b061645&브랜드상품코드=DP01000228&노드코드=00007&prcode=DP01000228">가입하기</a>
                <div class="card border-0 bg-secondary mb-4">
                    <div class="card-body">
                        <h5 class="mb-0 pb-3"><i class="fi-star mt-n1 me-2 fs-lg align-middle"></i>직장인을 위한 우대이율 혜택</h5>
                        <ul class="list-unstyled mt-n2 mb-0">
                            <li class="mt-2 mb-0"><b>급여이체 또는 KB국민카드 이용고객에는</b></li>
                            <li class="mt-2 mb-0">우대이율 혜택을 제공합니다.</li>
                        </ul>
                    </div>
                </div>
                <div class="card border-0 bg-secondary mb-4">
                    <div class="card-body">
                        <h5 class="mb-0 pb-3"><i class="fi-star mt-n1 me-2 fs-lg align-middle"></i>추가적립하면 우대이율도 추가로!</h5>
                        <ul class="list-unstyled mt-n2 mb-0">
                            <li class="mt-2 mb-0">월 정액적립금액을 초과하여 추가 적립시</li>
                            <li class="mt-2 mb-0">0.2%p의 우대이율 혜택을 제공합니다.</li>
                        </ul>
                    </div>
                </div>
