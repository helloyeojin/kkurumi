...
<section class="container mt-5 mb-lg-5 mb-4 pt-5 pb-lg-5">
    ...
    <nav class="mb-3 pt-md-3" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">KB청년도약계좌</li>
        </ol>
    </nav>
        ...
        <div class="col-lg-7">
            <div class="d-flex flex-column">
                ...
                <div class="order-lg-2 order-1">
                    <h1 class="h2 mb-2">KB청년도약계좌</h1>
                    <p class="mb-4 pb-1 fs-lg">힘찬 미래 높은 도약</p>
                    <ul class="d-flex pb-lg-2 list-unstyled" style="margin-bottom: 0">
                        <li class="me-3 pe-3 border-end"><b class="me-1">연 4.5% ~ 6%</b></li>
            ...
            <!-- Overview-->
            <h2 class="h5">가입절차</h2>
            <p>가입자격확인신청 및 적금신규는 지정된 기간의 영업일 오전 9시부터 오후 6시 30분 이내 가능</p>
            <p>ㅇ 가입신청 : 2023년 11월 6일(월) ~ 11월 17일(금)</p>
            <p>ㅇ 적금신규 : 2023년 12월 4일(월) ~ 12월 15일(금)</p>
            <p>(※ 가입대상으로 안내받은 고객에 한함)</p>
            <h2 class="h5">가입대상</h2>
            <p>거주자로서 다음 각 호의 요건을 모두 충족하는 실명의 개인 ※ 서민금융진흥원 및 은행연합회를 통해 아래의 가입대상 요건(①~④) 확인</p>
            <p>※ 전 금융기관 1인 1계좌</p>
            <p>※ 개인사업자, 임의단체 및 공동명의 가입 불가 (서류 미제출 임의단체 가입 불가)</p>
            <p>① 나이: 가입일 현재 만 19세 이상 만 34세 이하인 사람</p>
            <p>② 개인소득: 가입일 현재 다음 각 목 중 하나의 개인소득기준을 충족하는 사람</p>
            <p>가. 직전 과세기간 총 급여액이 7,500만원 이하</p>
            <p>나. 직전 과세기간의 종합소득과세표준에 합산되는 종합소득금액이 6,300만원 이하</p>
            <p>③ 가구소득 : 가입일 현재 가구원수에 따른 기준 중위소득주2) 180% 이하에 해당하는 사람</p>
            <p>④ 가입일이 속한 과세기간의 직전 3개년도 중 1회 이상 금융소득종합과세 대상자에 해당하지 않는 사람</p>
            <h2 class="h5">상품유형</h2>
            <p>자유적립식 예금</p>
            <p class="mb-4 pb-2">※ 매월(1일~말일) 자유롭게 저축(만기일 전일까지 저축 가능)</p>
            <h2 class="h5">저축금액</h2>
            <p>회차별 최소 1천원 이상 1천원 단위로, 매월(월 초일부터 말일까지) 70만원 이하</p>
            <h2 class="h5">계약기간</h2>
            <p>60개월</p>
            ...
            <div class="card card-horizontal">
                ...
                <blockquote class="blockquote card-body p-4">
                    <ul class="list-unstyled mt-n2 mb-0" style="font-size: 0.8rem">
                        <li>⊙ 상품 가입 전 서민금융진흥원을 통해 가입자격 충족여부를 확인합니다.</li>
                        <li>⊙ 만기일 전에 해지할 경우 중도해지 처리됩니다.</li>
                        <li>⊙ 일부해지 및 계약변경은 불가하나, 질권 설정은 가능합니다.</li>
                        <li>⊙ 계좌에 압류, 가압류 등이 등록 될 경우 원금 및 이자지급이 제한 될 수 있습니다.</li>
                        <li>⊙ 계약기간 동안 추심, 상계 등으로 가입자가 본인 납입금을 수령할 수 없는 경우 정부기여금을 지급하지 않습니다.</li>
                        <li>⊙ 이 적금 가입시 서민금융진흥원이 가입자에게 지급하는 정부기여금의 지급조건, 지급액, 지급시기 및 방법 등에 동의한 것으로 봅니다.</li>
                    </ul>
        ...
        <aside class="col-lg-5">
            <div class="ps-lg-5">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <div><span class="badge bg-success me-2 mb-2">정부기여금 지원 상품</span></div>
                ...
                <h2 class="h3 mb-4 pb-2">4.5% ~ 6%<span class="d-inline-block ms-1 fs-base fw-normal text-body">/ 연</span></h2>
                <!-- Property details-->
                ...
                <div class="card border-0 bg-secondary mb-4">
                    <div class="card-body">
                        <h5 class="mb-0 pb-3"><i class="fi-star mt-n1 me-2 fs-lg align-middle"></i>대한민국 청년이라면</h5>
                        <ul class="list-unstyled mt-n2 mb-0">
                            <li class="mt-2 mb-0">개인소득 6,000만원 이하,</li>
                            <li class="mt-2 mb-0">가구소득 중위 180% 이하,</li>
                            <li class="mt-2 mb-0">만 19~34세 이하</li>
                        </ul>
                    </div>
                </div>
                <div class="card border-0 bg-secondary mb-4">
                    <div class="card-body">
                        <h5 class="mb-0 pb-3"><i class="fi-star mt-n1 me-2 fs-lg align-middle"></i>매월 정부기여금 지원</h5>
                        <ul class="list-unstyled mt-n2 mb-0">
                            <li class="mt-2 mb-0">소득에 따라</li>
                            <li class="mt-2 mb-0">최대 월 2만 4천원 지원</li>
                        </ul>
                    </div>
                </div>
