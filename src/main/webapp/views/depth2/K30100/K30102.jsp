...
<section class="container mt-5 mb-lg-5 mb-4 pt-5 pb-lg-5">
    ...
    <nav class="mb-3 pt-md-3" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">가온올림카드</li>
        </ol>
    </nav>
        ...
        <div class="col-lg-7">
            <div class="d-flex flex-column">
                ...
                <div class="order-lg-2 order-1">
                    <h1 class="h2 mb-2">가온올림카드</h1>
                    <p class="mb-4 pb-1 fs-lg">누구나 탐내는 카드</p>
                </div>
            </div>
            <!-- Overview-->
            <h2 class="h5">상품특징</h2>
        ...
        <aside class="col-lg-5">
            <div class="ps-lg-5">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <div><span class="badge bg-success me-2 mb-2">신용카드 BEST</span></div>
