...
<section class="container mt-5 mb-lg-5 mb-4 pt-5 pb-lg-5">
    ...
    <nav class="mb-3 pt-md-3" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">KB 국민ONE대출</li>
        </ol>
    </nav>
        ...
        <div class="col-lg-7">
            <div class="d-flex flex-column">
                ...
                <div class="order-lg-2 order-1">
                    <h1 class="h2 mb-2">KB 국민ONE대출</h1>
                    <p class="mb-4 pb-1 fs-lg">우수고객님은 대출도 ONE샷!</p>
                    ...
                    <ul class="d-flex mb-4 pb-lg-2 list-unstyled">
                        ...
                        <li class="me-3 pe-3 border-end"><b class="me-1">2천만원</b></li>
                    </ul>
                </div>
            </div>
            <!-- Overview-->
            <h2 class="h5">상품특징</h2>
            <p class="mb-4 pb-2">입증소득 및 재직증빙이 없어도 당행 거래실적에 따라 신용평가시스템(CSS) 평가 후 산출되는 CSS 평가 등급별로 무보증 대출한도가 부여되는 신용대출 상품</p>
            <h2 class="h5">대출신청자격</h2>
            <p>다음 중 하나의 조건에 해당하는 고객</p>
            <p>☞ 당행 1년이상 거래고객(고객정보등록일 기준) 중 거래실적 우수고객</p>
            <p>☞ 「KB국민ONE통장」가입고객 중 거래실적 우수고객으로 다음 거래 조건을 모두 충족하는 고객</p>
            <p>① 자동이체 4건 이상(아파트관리비 자동이체 필수이며 계좌간 자동이체는 제외)</p>
            <p>② KB국민ONE통장 가입고객 : 최근 6개월 총수신 평균잔액 50만원 이상 등</p>
            <p>※거래실적 우수고객</p>
            <p>＊ 당행 1년이상 거래고객 : 최근6개월 총수신 평균잔액 300만원 이상 등</p>
            <p class="mb-4 pb-2">＊ KB국민ONE통장 가입고객 : 최근 6개월 총수신 평균잔액 50만원 이상 등</p>
            <h2 class="h5">대출금액</h2>
            <p>무보증최고 2천만원 이내</p>
            <p>(KB국민ONE통장 가입고객 중 거래실적 우수고객 자격으로 대출을 받으시는 경우에는 최고 5백만원)</p>
            <p class="mb-4 pb-2">※ 대출한도는 신용평가결과에 따라 차등 적용됩니다.</p>
            <h2 class="h5">대출기간 및 상환방법</h2>
            <p><b>- 일시상환(종합통장자동대출 포함): 1년(최장10년까지 기한연장 가능)</b></p>
            <p><b>- 원(리)금균등 분할상환</b></p>
            <p>① CSS 1~3등급 : 최저 1년 이상 최장 10년 이내</p>
            <p>② CSS 4등급 이하 : 최저 1년 이상 최장 5년 이내</p>
            <p>※ 대출기간 30% 이내 최장 12개월까지 거치기간 운용 가능</p>
            <p class="mb-4 pb-2">※ KB국민ONE통장 가입고객 중 거래실적 우수고객 자격으로 대출을 받으시는 경우에는 종합통장자동대출만 가능합니다.</p>
            <h2 class="h5">필요서류</h2>
            <p>본인신분증 (주민등록증, 자동차운전면허증,국내에서 발행한 여권 등)</p>
            <p>신용대출 합산 1억원(당행 신규 및 全금융기관 잔액 합계) 초과시, 아래 서류 필수제출</p>
            <p>- 소득 있는 경우 : [ ①, ② 모두 ]</p>
            <p>① 재직(사업)사실 확인서류 (재직증명서 또는 사업자등록증 등)</p>
            <p>② 소득확인서류 (근로소득원천징수영수증 또는 소득금액증명원 등)</p>
            <p class="mb-4 pb-2">- 소득 없는 경우 : [ ①, ② 中 택 1] ①국세청 사실증명원, ②건강보험자격득실확인원 (피부양자의 경우에 한함)</p>
            ...
            <div class="card card-horizontal">
                ...
                <blockquote class="blockquote card-body p-4">
                    <ul class="list-unstyled mt-n2 mb-0" style="font-size: 0.8rem">
                        <li>⊙ 일반금융소비자는 은행이 계약 체결을 권유하는 경우 및 일반금융소비자가 설명을 요청하는 경우에도 중요한 사항을 이해할 수 있도록 설명받을 권리가 있습니다.</li>
                        <li>⊙ 대출신청인이 신용도판단정보 등록자(신용회복지원 또는 배드뱅크 포함)이거나 은행의 신용평가 결과 신용등급이 낮은 고객일 경우 대출이 제한될 수 있습니다.</li>
                        <li>⊙ 상환능력에 비해 대출금, 신용카드 사용액이 과도할 경우 개인신용평점 하락할 수 있으며, 개인신용평점 하락으로 금융거래와 관련된 불이익이 발생할 수 있습니다. 또한 대출 취급 후 일정 기간 납부해야 할 원리금이 연체될 경우, 계약만료 기한이 도래하기 전에 모든 원리금을 변제해야 할 의무가 발생할 수 있습니다.</li>
                        <li>⊙ 금리재산정주기 도래 또는 기한연장 시 거래실적에 따른 우대금리 조건 충족여부, 신용등급 변화 등에 따라 금리가 변동될 수 있습니다.</li>
                        <li>⊙ 대출 사실만으로 신용점수는 하락할 수 있습니다.</li>
                        <li>⊙ 이 상품은 '약정한도 증감방식 한도거래대출(내맘대로 통장자동대출)' 선택 시 최초 약정금액 범위 내에서 자유로운 한도조절이 가능한 상품으로, 자세한 사항은 추가약정서(내맘대로통장자동대출 약정한도 증/감액용)을 참조하시기 바랍니다.</li>
                        <li>⊙ 이 상품은 KB국민은행 개인여신부(P)에서 개발한 상품입니다. 기타 자세한 내용은 영업점 직원 또는 고객센터(☎1588-9999)에 문의하시거나 KB국민은행 홈페이지(www.kbstar.com)를 참조하여 주시기 바랍니다.</li>
                        <li>⊙ 본 공시는 상품에 대한 이해를 돕고 약관의 중요내용을 알려드리기 위한 참고자료이며, 실제상품의 계약은 대출거래약정서, 여신거래기본약관 등의 적용을 받기 때문에 대출계약을 체결하기 전에 반드시 상품설명서 및 관련 약관을 읽어보시기 바랍니다. 약관은 창구 및 KB국민은행 홈페이지(www.kbstar.com:전체서비스->고객센터 -> 서식/약관/설명서)에서 교부 및 열람이 가능합니다.</li>
                    </ul>
                </blockquote>
            </div>
        </div>
        ...
        <aside class="col-lg-5">
            <div class="ps-lg-5">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <div><span class="badge bg-success me-2 mb-2">우수 고객 추천</span></div>
                ...
                <h2 class="h3 mb-4 pb-2">최저 7.25% ~ 8.15%<span class="d-inline-block ms-1 fs-base fw-normal text-body">/ 연</span></h2>
                <!-- Property details-->
                <div class="card border-0 bg-secondary mb-4">
                    <div class="card-body">
                        <h5 class="mb-0 pb-3"><i class="fi-star mt-n1 me-2 fs-lg align-middle"></i>우대금리: 최고 연 0.9%p 우대</h5>
                        <ul class="list-unstyled mt-n2 mb-0">
                            <li class="mt-2 mb-0">KB신용카드 이용실적 우대 : 최고 연 0.3%p</li>
                            <li class="mt-2 mb-0">급여(연금)이체 관련 실적 우대 : 연 0.3%p</li>
                            <li class="mt-2 mb-0">적립식예금(30만원 이상) 보유 우대 : 연 0.1%p</li>
                            <li class="mt-2 mb-0">자동이체(3건 이상) 실적 우대 : 연 0.1%p</li>
