...
<section class="container mt-5 mb-lg-5 mb-4 pt-5 pb-lg-5">
    ...
    <nav class="mb-3 pt-md-3" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="/K20100">개인대출</a></li>
            <li class="breadcrumb-item active" aria-current="page">KB 주택전세자금대출 (은행재원 협약보증)</li>
        </ol>
    </nav>
        ...
        <div class="col-lg-7">
            <div class="d-flex flex-column">
                ...
                <div class="order-lg-2 order-1">
                    <h1 class="h2 mb-2">KB 주택전세자금대출 (은행재원 협약보증)</h1>
                    <p class="mb-4 pb-1 fs-lg">고객님의 전세금을 지원하는</p>
                    <ul class="d-flex pb-lg-2 list-unstyled" style="margin-bottom: 0">
                        <li class="me-3 pe-3 border-end">기간</li>
                        <li class="me-3 pe-3 border-end"><b class="me-1">최장 3년</b></li>
                    </ul>
                    <ul class="d-flex mb-4 pb-lg-2 list-unstyled">
                        <li class="me-3 pe-3 border-end">최고</li>
                        <li class="me-3 pe-3 border-end"><b class="me-1">5억원</b></li>
                    </ul>
                </div>
            </div>
            <!-- Overview-->
            <h2 class="h5">상품특징</h2>
            <p class="mb-4 pb-2">전세 신규입주 또는 계약갱신을 하시는 시기에 서울보증보험 보증서 담보로 지원하는 전세대출상품</p>
            <h2 class="h5">대출신청자격</h2>
            <p>민법상 성년인 세대주(단독세대주 포함)이며 "서울보증보험증권"이 발급되는 고객으로서 아래의 사항을 모두 충족하는 고객</p>
            <p>1. 부동산 중개업소를 통하여 주택임대차계약을 체결하고 임차보증금의 5% 이상을 계약금으로 지급한 경우</p>
            <p>2. 본인과 배우자(결혼예정자 포함)의 합산 주택 보유수가 1주택 이내인 경우</p>
            <p class="mb-4 pb-2">* 보유 중인 주택이 2020.7.10 이후 취득(상속제외)한 투기지역 또는 투기과열지구 소재 취득시점 3억원을 초과하는 아파트인 경우 제외, 단 실수요 예외 증빙이 가능한 경우 예외취급 가능</p>
            <h2 class="h5">대출금액</h2>
            <p>최소 5백만원 이상 최고 5억원 이하로 아래 세 가지 금액 중 작은 금액이내</p>
            <p>☞ 임차보증금액의 80% 이내</p>
            <p>☞ 임차물건지의 선순위 설정최고액과 전세대출금의 합계가 시세의 80% 이내</p>
            <p>☞ 본인 및 배우자(결혼예정자 포함)가 보유한 주택이 1주택인 경우 최고 3억원 이내</p>
            <p class="mb-4 pb-2">※ 실제 대출금액은 연소득,부채금액 등 개인별 신용평가에 의해 결정되며, 대출신청금액은 최저 5백만원 이상으로 운용됩니다./p>
            <h2 class="h5">대출기간 및 상환방법</h2>
            <p>대출기간 : 3개월이상 3년이내</p>
            <p>(임차계약 종료일 이내, 임대기간 연장시 매회 최대3년(묵시적 연장은 2년)이내로, 최장 10년 이내 연장)</p>
            <p class="mb-4 pb-2">상환방법 : 만기일시상환, 원(리)금균등분할상환</p>
            <h2 class="h5">대출대상주택</h2>
            <p class="mb-4 pb-2">아파트, 연립, 다세대, 주거용오피스텔, 노인복지주택</p>
            <h2 class="h5">대출신청시기</h2>
            <p>신규임차자금: 입주 전 7영업일 이전</p>
            <p class="mb-4 pb-2">생활안정자금: 임대차계약서상 잔금지급일과 주민등록전입일 중 빠른날로부터 3개월 이내[임대차계약을 자동기한연장(묵시적 갱신)한 경우에는 연장개시일로부터 3개월 이내]</p>
            <h2 class="h5">필요서류</h2>
            <p>- 본인신분증 (주민등록증, 자동차운전면허증,국내에서 발행한 여권 등)</p>
            <p>신용대출 합산 1억원(당행 신규 및 全금융기관 잔액 합계) 초과시, 아래 서류 필수제출</p>
            <p>- 소득 있는 경우 : [ ①, ② 모두 ]</p>
            <p>- 확정일자부 임대차(전세)계약서 (계약갱신의 경우 구 임대차계약서)</p>
            <p>- 계약금 영수증 또는 은행 무통장입금증</p>
            <p>- 재직 및 소득확인서류</p>
            <p>- 주민등록등본(최근 1개월이내 발급분)</p>
            <p class="mb-4 pb-2">- 대출심사 과정에서 필요한 경우 가족관계증명서, 임대인 통장사본 등 추가서류 제출을 요청할 수 있습니다.</p>
            <h2 class="h5">만기경과 후 기한의 이익 상실에 대한 안내</h2>
            <p>만기일 경과 후 대출금액을 전액 상환하지 않거나 기한 연장하지 않은 경우, 은행여신거래기본약관에 따라 기한의 이익이 상실되어 대출잔액에 대한 지연배상금이 부과됨.</p>
            <p class="mb-4 pb-2">연체가 계속되는 경우, 연체기간에 따라 『신용정보의 이용 및 보호에 관한 법률』과 『일반신용정보 관리규약』에 따라 "연체정보 등"으로 등록되어 금융 불이익을 받을 수 있음.</p>
            <!-- Rental agent-->
            <h2 class="h5">유의사항</h2>
            <div class="card card-horizontal">
                ...
                <blockquote class="blockquote card-body p-4">
                    <ul class="list-unstyled mt-n2 mb-0" style="font-size: 0.8rem">
                        <li>⊙ 임차보증금반환채권 질권설정에 대한 통지비용(3만원)은 고객부담으로 대출실행시 고객계좌에서 출금됩니다.</li>
                        <li>⊙ 대출신청인이 신용도판단정보 등록자(신용회복지원 또는 배드뱅크 포함)이거나 은행의 신용평가 결과 신용등급이 낮은 고객일 경우 대출이 제한될 수 있습니다.</li>
                        <li>⊙ 대출 사실만으로 신용점수는 하락할 수 있습니다.</li>
                        <li>⊙ 약정납일입이 경과되면 연체이자가 부과되며, 대출만기일이 경과하거나 이자를 납입하여야 할 때부터 1개월간 지체한 때, 분할상환원(리)금의 납입을 2회 이상 연속하여 지체한 때에는 대출잔액에 대하여 연체이자가 부과됩니다.</li>
                        <li>⊙ 상환능력에 비해 대출금, 신용카드 사용액이 과도할 경우 개인신용평점 하락과 금융거래와 관련된 불이익이 발생할 수 있습니다. 또한, 원리금 연체시 계약만기 전에 모든 원리금의 변제의무가 발생할 수 있습니다.</li>
                        <li>⊙ 금리재산정주기가 도래하거나 대출금을 기한연장하는 경우에는 고객님의 거래실적, 우대금리 제공조건 충족여부, 신용등급 변화 등에 따라 금리가 하락 또는 상승될 수 있습니다.</li>
                        <li>⊙ 대출 고객께서는 은행 담당자로부터 COFIX에 대한 설명을 충분히 들으시고, 각 기준금리의 특징을 이해하신 후 본인에게 적합한 대출상품을 선택하시기 바랍니다.</li>
                        <li>⊙ 금융소비자는 해당 상품 또는 서비스에 대하여 설명받을 권리가 있습니다.</li>
                        <li>⊙ 이 상품은 KB국민은행 개인여신부(P)에서 개발한 상품입니다.</li>
                        <li>⊙ 기타 자세한 내용은 영업점 직원 또는 KB국민은행 고객센터(☎1588-9999)에 문의하시거나 KB국민은행 홈페이지(www.kbstar.com)를 참조하여 주시기 바랍니다.</li>
                        <li>⊙ 본 공시는 상품에 대한 이해를 돕고 약관의 중요내용을 알려드리기 위한 참고자료이며, 실제상품의 계약은 대출거래약정서, 여신거래기본약관 등의 적용을 받기 때문에 대출계약을 체결하기 전에 반드시 상품설명서 및 관련 약관을 읽어보시기 바랍니다.</li>
                    </ul>
                </blockquote>
            </div>
        </div>
        ...
        <aside class="col-lg-5">
            <div class="ps-lg-5">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <div><span class="badge bg-success me-2 mb-2">전세자금대출</span></div>
                ...
                <h2 class="h3 mb-4 pb-2">최저 4.69% ~ 6.74%<span class="d-inline-block ms-1 fs-base fw-normal text-body">/ 연</span></h2>
                <!-- Property details-->
                <div class="card border-0 bg-secondary mb-4">
                    <div class="card-body">
                        <h5 class="mb-0 pb-3"><i class="fi-star mt-n1 me-2 fs-lg align-middle"></i>우대금리: 최고 연 1.4%p 우대</h5>
                        <ul class="list-unstyled mt-n2 mb-0">
                            <li class="mt-2 mb-0">① 실적연동 우대금리 : 최고 연 0.9%p</li>
                            <li class="mt-2 mb-0">- KB국민카드(신용) 이용실적 우대 : 연 0.1%p ~ 연 0.3%p</li>
                            <li class="mt-2 mb-0">- 급여(연금)이체 실적 우대 : 연 0.1%p ~ 연 0.3%p</li>
                            <li class="mt-2 mb-0">- 자동이체 거래실적 우대(3건 이상) : 연 0.1%p</li>
                            <li class="mt-2 mb-0">- 적립식예금 30만원 이상 계좌 보유 우대 : 연 0.1%p</li>
                            <li class="mt-2 mb-0">- KB 스타뱅킹 이용 우대 : 연 0.1%p</li>
                            <li class="mt-2 mb-0">② 부동산 전자계약 우대(연 0.2%p), 주택자금대출에 대한 취약차주 우대(연 0.3%p)</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="d-flex">
                    ...
                    <ul class="list-unstyled fs-sm" style="display:flex;align-content: center;flex-direction: column;justify-content: center;margin-bottom:0">
                        <li style="font-size: larger; color: #FD5631;"><b>상품이 어렵게 느껴지시나요?</b></li>
