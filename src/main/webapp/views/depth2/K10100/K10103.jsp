...
<section class="container mt-5 mb-lg-5 mb-4 pt-5 pb-lg-5">
    ...
    <nav class="mb-3 pt-md-3" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">KB종합통장</li>
        </ol>
    </nav>
        ...
        <div class="col-lg-7">
            <div class="d-flex flex-column">
                ...
                <div class="order-lg-2 order-1">
                    <h1 class="h2 mb-2">KB종합통장</h1>
                    <p class="mb-4 pb-1 fs-lg">입출금이 자유로운 대표상품</p>
            ...
            <!-- Overview-->
            <h2 class="h5">상품특징</h2>
            <p class="mb-4 pb-2">가입대상에 제한이 없고 소비자금 또는 유휴자금의 일시적 보관을 목적으로 개설하는 입출금이 자유로운 예금의 대표적인 상품</p>
            <h2 class="h5">가입대상</h2>
            <p class="mb-4 pb-2">제한없음</p>
            <!-- Rental agent-->
            <h2 class="h5">유의사항</h2>
        ...
        <aside class="col-lg-5">
            <div class="ps-lg-5">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <div><span class="badge bg-success me-2 mb-2">대표 상품</span></div>
                ...
                <!-- Property details-->
                <a class="btn btn-lg btn-primary w-100 mb-3" href="https://obank.kbstar.com/quics?page=C016613&cc=b061496:b061645&브랜드상품코드=DP01000005&QSL=F&prcode=DP01000005">가입하기</a>
                <div class="card border-0 bg-secondary mb-4">
                    <div class="card-body">
                        <h5 class="mb-0 pb-3"><i class="fi-star mt-n1 me-2 fs-lg align-middle"></i>누구나 쉽고 간편하게 가입</h5>
                        <ul class="list-unstyled mt-n2 mb-0">
                            <li class="mt-2 mb-0"><b>가입대상 제한 없이</b></li>
                            <li class="mt-2 mb-0">누구나 가입할 수 있어요.</li>
                        </ul>
                    </div>
                </div>
                <div class="card border-0 bg-secondary mb-4">
                    <div class="card-body">
                        <h5 class="mb-0 pb-3"><i class="fi-star mt-n1 me-2 fs-lg align-middle"></i>자유로운 입출금</h5>
                        <ul class="list-unstyled mt-n2 mb-0">
                            <li class="mt-2 mb-0">필요할 때마다 언제든지</li>
                            <li class="mt-2 mb-0">입출금할 수 있어요.</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card border-0 bg-secondary mb-4">
                    <div class="card-body">
                        <h5 class="mb-0 pb-3"><i class="fi-star mt-n1 me-2 fs-lg align-middle"></i>예치기간도 제한 NO!</h5>
                        <ul class="list-unstyled mt-n2 mb-0">
                            <li class="mt-2 mb-0">기간과 상관없이 원하시는 만큼</li>
                            <li class="mt-2 mb-0">자유롭게 사용이 가능해요.</li>
                        </ul>
                    </div>
                </div>
                <!-- Post meta-->
