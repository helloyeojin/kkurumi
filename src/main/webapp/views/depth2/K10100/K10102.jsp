...
<section class="container mt-5 mb-lg-5 mb-4 pt-5 pb-lg-5">
    ...
    <nav class="mb-3 pt-md-3" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">직장인우대종합통장</li>
        </ol>
    </nav>
    <div class="row gy-5 pt-lg-2">
        <div class="col-lg-7">
            <div class="d-flex flex-column">
                ...
                <div class="order-lg-1 order-2">
                    <div>
                        <div>
                            <div><img class="rounded-3" src="img/real-estate/sf2.png" alt="Image"></div>
                        </div>
                    </div>
                </div>
                <!-- Page title + Features-->
                <div class="order-lg-2 order-1">
                    <h1 class="h2 mb-2">직장인우대종합통장</h1>
                    <p class="mb-4 pb-1 fs-lg">슬기로운 직장생활을 위한 똑똑한 급여통장</p>
                    <ul class="d-flex pb-lg-2 list-unstyled" style="margin-bottom: 0">
                        <li class="me-3 pe-3 border-end"><b class="me-1">연 0.1%</b></li>
                        <li class="me-3 pe-3 border-end">※ 결산일 현재 영업점에 고시한 기본이율 적용(2023.3.17, 세금공제 전)</li>
                    </ul>
                    <ul class="d-flex pb-lg-2 list-unstyled" style="margin-bottom: 0">
                        <li class="me-3 pe-3 border-end">- 단, 만20세 이상 65세 미만 고객에 대해 결산기간 평잔이 1백만원 미만인 경우는 연 0.1% 적용</li>
                    </ul>
            ...
            <!-- Overview-->
            <h2 class="h5">상품특징</h2>
            <p class="mb-4 pb-2">급여이체 고객을 대상으로 전자금융 수수료 면제 및 자동화기기 이용수수료 면제, 수신 금리우대, 외환수수료 우대 서비스를 제공하는 예금상품</p>
            <h2 class="h5">가입대상</h2>
            <p class="mb-4 pb-2">실명의 개인(1인 1계좌)</p>
            <h2 class="h5">상품유형</h2>
            <p class="mb-4 pb-2">입출금이 자유로운 예금 (보통예금, 저축예금, 가계당좌예금)</p>
            <h2 class="h5">수수료면제</h2>
            <p>- 전자금융 이체수수료(다른은행으로 보낼 때)</p>
            <p>- KB국민은행 자동화기기 시간외출금수수료</p>
            <p>- KB국민은행 자동화기기 이체수수료 (다른은행으로 보낼 때)</p>
            <p>- 다른은행 자동화기기 출금수수료</p>
            <p class="mb-4 pb-2">(자세한 수수료우대 혜택은 상품설명서 참조)</p>
            <!-- Rental agent-->
            <h2 class="h5">유의사항</h2>
        ...
        <aside class="col-lg-5">
            <div class="ps-lg-5">
                ...
                <!-- Property details-->
                <a class="btn btn-lg btn-primary w-100 mb-3" href="https://obank.kbstar.com/quics?page=C016613&cc=b061496:b061645&%EB%B8%8C%EB%9E%9C%EB%93%9C%EC%83%81%ED%92%88%EC%BD%94%EB%93%9C=DP01000104&QSL=F&prcode=DP01000104">가입하기</a>
                <div class="card border-0 bg-secondary mb-4">
                    <div class="card-body">
                        <h5 class="mb-0 pb-3"><i class="fi-star mt-n1 me-2 fs-lg align-middle"></i>외환 수수료 최대 50% 우대</h5>
                        <ul class="list-unstyled mt-n2 mb-0">
                            <li class="mt-2 mb-0"><b>가입만 해도 창구 환전수수료 30% 우대</b></li>
                            <li class="mt-2 mb-0">급여이체 고객이라면</li>
                            <li class="mt-2 mb-0">송금 보낼 때도 50% 우대해드려요.</li>
                        </ul>
                    </div>
                </div>
                <div class="card border-0 bg-secondary mb-4">
                    <div class="card-body">
                        <h5 class="mb-0 pb-3"><i class="fi-star mt-n1 me-2 fs-lg align-middle"></i>차곡차곡 쌓이는 적금, 금리 우대의 기회</h5>
                        <ul class="list-unstyled mt-n2 mb-0">
                            <li class="mt-2 mb-0">KB상호부금에 가입시</li>
                            <li class="mt-2 mb-0">연 0.3%p의 우대 금리를 드려요.</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card border-0 bg-secondary mb-4">
                    <div class="card-body">
                        <h5 class="mb-0 pb-3"><i class="fi-star mt-n1 me-2 fs-lg align-middle"></i>실적에 따라 거래 수수료 면제</h5>
                        <ul class="list-unstyled mt-n2 mb-0">
                            <li class="mt-2 mb-0">최근 3개월 실적에 따라</li>
                            <li class="mt-2 mb-0">다양한 수수료 면제 혜택이 따라와요.</li>
                        </ul>
                    </div>
                </div>
                <!-- Post meta-->
