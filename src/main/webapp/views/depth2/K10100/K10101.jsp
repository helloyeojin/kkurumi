...
<section class="container mt-5 mb-lg-5 mb-4 pt-5 pb-lg-5">
    ...
    <div class="row gy-5 pt-lg-2">
        <div class="col-lg-7">
            ...
            <!-- Overview-->
            <h2 class="h5">상품특징</h2>
            <p class="mb-4 pb-2">생활 속 은행 거래실적에 따라 다양한 수수료 면제 서비스를 제공하는 입출금이자유로운예금</p>
            <h2 class="h5">가입대상</h2>
            <p>실명의 개인(1인 1계좌)</p>
            <p>※ 보통예금 : 개인, 개인사업자, 관련서류 미제출 임의단체</p>
            <p class="mb-4 pb-2">※ 저축예금 : 개인, 관련서류 미제출 임의단체</p>
            <h2 class="h5">상품유형</h2>
            <p>입출금이 자유로운 예금(보통예금, 저축예금)</p>
            <p class="mb-4 pb-2">※ 창구 또는 비대면채널을 통한 전환 가입 가능(단, 동일 예금과목에 한해 가능)</p>
            <h2 class="h5">수수료면제</h2>
            <p>- 전자금융 이체수수료(다른은행으로 보낼 때)</p>
            <p>- KB국민은행 자동화기기 시간외출금수수료</p>
            <p>- 납부자 자동이체 (타행자동이체 포함) 수수료 등</p>
