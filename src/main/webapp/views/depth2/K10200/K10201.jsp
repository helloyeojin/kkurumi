...
<section class="container mt-5 mb-lg-5 mb-4 pt-5 pb-lg-5">
    ...
    <nav class="mb-3 pt-md-3" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">국민UP정기예금</li>
        </ol>
    </nav>
        ...
        <div class="col-lg-7">
            <div class="d-flex flex-column">
                ...
                <div class="order-lg-2 order-1">
                    <h1 class="h2 mb-2">국민UP정기예금</h1>
                    <p class="mb-4 pb-1 fs-lg">월복리로 목돈 굴리는 예금</p>
                    <ul class="d-flex pb-lg-2 list-unstyled" style="margin-bottom: 0">
                        <li class="me-3 pe-3 border-end"><b class="me-1">연평균 약 2.42% (월복리 효과 포함)</b></li>
                        <li class="me-3 pe-3 border-end">※ 신규시점에 고시된 월단위 약정이율 적용. 이자는 월단위로 복리계산</li>
                    </ul>
                    <ul class="d-flex pb-lg-2 list-unstyled" style="margin-bottom: 0">
                        <li class="me-3 pe-3 border-end"><b class="me-1">우대이율 최고 연 0.2%p</b></li>
                        <li class="me-3 pe-3 border-end">※ 신규가입일 당시 영업점 및 KB국민은행 홈페이지에 게시한 항목별 우대이율 적용</li>
                    </ul>
            ...
            <!-- Overview-->
            <h2 class="h5">상품특징</h2>
            <p class="mb-4 pb-2">1개월 단위로 이율이 상승하는 계단식 금리구조 및 일부인출 서비스를 통해 거래편의성을 높이고 KB국민은행 및 KB국민카드 상품 거래시 우대이율을 제공하는 월복리 정기예금</p>
            <h2 class="h5">가입대상</h2>
            <p>제한없음 (단, 금융기관 제외)</p>
            <h2 class="h5">적립방법 및 저축금액</h2>
            <p>3백만원 이상(개인/개인사업자), 3천만원 이상(법인)</p>
            <h2 class="h5">계약기간</h2>
            <p>12개월</p>
            <h2 class="h5">일부인출</h2>
            <p>- 대상계좌 : 예치기간 1개월 이상 경과된 계좌</p>
            <p>- 인출횟수 : 만기(또는 중도)해지 포함 총 3회</p>
            <p>- 인출금액 : 10만원 이상 원단위 (일부인출 후 최저유지잔액 1백만원 이상)</p>
            <!-- Rental agent-->
            <h2 class="h5">유의사항</h2>
            <div class="card card-horizontal">
                ...
                <blockquote class="blockquote card-body p-4">
                    <ul class="list-unstyled mt-n2 mb-0" style="font-size: 0.8rem">
                        ...
                        <li>⊙ 이 예금은 공동명의로 가입이 제한되며, 개인(개인사업자 포함)고객과 법인(또는 임의단체)간 양도·양수가 불가합니다.</li>
        ...
        <aside class="col-lg-5">
            <div class="ps-lg-5">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <div><span class="badge bg-success me-2 mb-2">예금BEST</span></div>
                ...
                <h2 class="h3 mb-4 pb-2">누적평균 약 2.42%<span class="d-inline-block ms-1 fs-base fw-normal text-body">/ 연</span></h2>
                <!-- Property details-->
                ...
                <div class="card border-0 bg-secondary mb-4">
                    <div class="card-body">
                        <h5 class="mb-0 pb-3"><i class="fi-star mt-n1 me-2 fs-lg align-middle"></i>매월 복리로 상승하는 이율</h5>
                        <ul class="list-unstyled mt-n2 mb-0">
                            <li class="mt-2 mb-0"><b>이자에 이자가 붙는 월복리로</b></li>
                            <li class="mt-2 mb-0">목돈을 굴려보세요</li>
                        </ul>
                    </div>
                </div>
                <div class="card border-0 bg-secondary mb-4">
                    <div class="card-body">
                        <h5 class="mb-0 pb-3"><i class="fi-star mt-n1 me-2 fs-lg align-middle"></i>급할 땐 일부 출금 가능</h5>
                        <ul class="list-unstyled mt-n2 mb-0">
                            <li class="mt-2 mb-0">해지없이 필요한 금액만 출금이 가능해요.</li>
                            <li class="mt-2 mb-0">(예치기간 만기, 또는 중도해지 포함 3회 이내)</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card border-0 bg-secondary mb-4">
                    <div class="card-body">
                        <h5 class="mb-0 pb-3"><i class="fi-star mt-n1 me-2 fs-lg align-middle"></i>최대 0.2%p 우대 이율 혜택</h5>
                        <ul class="list-unstyled mt-n2 mb-0">
                            <li class="mt-2 mb-0">KB국민은행 적금, 외화예금 잔액,</li>
                            <li class="mt-2 mb-0">KB카드 이용실적에 따라 우대 이율을 제공해요.</li>
                        </ul>
                    </div>
                </div>
                <!-- Post meta-->
